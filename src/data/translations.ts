...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    quickActions: {
      ...
      askAiTitle: 'Ask SmartGuide',
      askAiDesc: 'Ask your question in simple everyday language.',
    },
    howItWorks: {
      title: 'How BIS SmartGuide Works',
  ...
  hi: {
    ...
    quickActions: {
      ...
      askAiTitle: 'स्मार्टगाइड से पूछें',
      askAiDesc: 'अपनी भाषा में कोई भी सवाल पूछें और तुरंत जवाब पाएं।',
    },
    howItWorks: {
      title: 'BIS स्मार्टगाइड कैसे काम करता है',
      ...
      step2Title: 'स्मार्टगाइड समझता है',
